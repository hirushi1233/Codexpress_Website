    ...
    <div class="container">
        ...
        <span style="font-size: 36px;">X</span>press
                    ...
                    <ul class="nav">
                                ...
                                <div class="mega-dropdown-container">
                                    <div class="mega-dropdown-content">
                                        ...
                                        <div class="mega-sidebar">
                                            <h3>Solutions.</h3>
                                            <p>Get <a href="#services">software development services</a>, built around your needs:</p>
                                    ...
                                    <div class="mega-footer">
                                        <a href="#all-solutions" class="view-all-link">All Solutions →</a>
                                    </div>
                                </div>
                            </div>
                        </li>
                            ...
                            <div class="mega-dropdown-menu">
                                <div class="mega-dropdown-container">
                                    <div class="mega-dropdown-content">
                                        ...
                                        <div class="mega-sidebar">
                                            <h3>Technologies.</h3>
                                            <p>Get experts in 100+ technologies. Cover any tech stack.</p>
                                            <ul class="sidebar-links">
                                                <li><a href="#hire-developers">Hire Software Developers</a></li>
                                                <li><a href="#top-talent">Top 1% Talent</a></li>
                                            </ul>
                                    ...
                                    <!-- View All Link -->
                                    <div class="mega-footer">
                                        <a href="#all-technologies" class="view-all-link">All Technologies →</a>
                                    </div>
                                </div>
                            </div>
                        </li>
                        ...
                        <li class="scroll-to-section has-mega-dropdown">
                            <a href="{{route('industries.index')}}" style="color: #1a1a1a; font-weight: 700;">Industries <i class="fa fa-angle-down"></i></a>
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        const dropdownItems = document.querySelectorAll('.has-dropdown > a, .has-mega-dropdown > a');
        ...
        dropdownItems.forEach(item => {
            item.addEventListener('click', function(e) {
                if (window.innerWidth <= 991) {
                    ...
                    document.querySelectorAll('.has-dropdown, .has-mega-dropdown').forEach(dropdown => {
                        if (dropdown !== parent) {
